		...
		Repetir
			...
			Segun compra Hacer
				1:
					...
					Leer resta_uno;
					si resta_uno>cantidad_uno Entonces
						Mostrar "La cantidad seleccionada excede el inventario disponible";
					FinSi
				Hasta Que resta_uno>0 y resta_uno<=cantidad_uno
				...
				2:
					...
					Leer resta_dos;
					si resta_dos>cantidad_dos Entonces
						Mostrar "La cantidad seleccionada excede el inventario disponible";
					FinSi
				Hasta Que resta_dos>0 y resta_dos<=cantidad_dos
				...
				3:
					...
					Leer resta_tres;
					si resta_tres>cantidad_tres Entonces
						Mostrar "La cantidad seleccionada excede el inventario disponible";
					FinSi
				Hasta Que resta_tres>0 y resta_tres<=cantidad_tres
				...
				4:	
					...
					Leer resta_cuatro;
					si resta_cuatro>cantidad_cuatro Entonces
						Mostrar "La cantidad seleccionada excede el inventario disponible";
					FinSi
				Hasta Que resta_cuatro>0 y resta_cuatro<=cantidad_cuatro
